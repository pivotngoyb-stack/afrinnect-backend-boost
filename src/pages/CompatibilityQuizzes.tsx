  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-muted via-purple-50/30 to-amber-50/20 relative pb-24">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold text-foreground mb-6 text-center">Discover Your Compatibility Type</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-white/70 backdrop-blur-md border-2 border-purple-200 shadow-lg hover:shadow-xl transition-all cursor-pointer transform hover:scale-105" onClick={() => setShowCouplesComparison(true)}>
            ...
            <CardContent className="pt-12">
               <CardTitle className="text-xl font-bold text-foreground mb-2">Couples Comparison</CardTitle>
               <p className="text-sm text-muted-foreground mb-4">Compare compatibility with your matches. Unlock deep insights for just $2.</p>
                ...
                <CardContent className="space-y-3">
                  {userResult && (
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 mb-3">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">{getResultDescription(userResult, quiz)}</p>
                    </div>
                  )}
        ...
        <DialogContent className="max-w-2xl p-6 bg-white/90 backdrop-blur-lg rounded-2xl shadow-2xl">
          ...
          {!showResult ? (
            <div className="space-y-6">
              ...
              <h3 className="text-xl font-semibold text-foreground mt-4">{currentQuestion?.question_text}</h3>
              <div className="space-y-3">
                {currentQuestion?.options.map((option, index) => (
                  <Button
                    key={index}
                    variant="outline"
                    className="w-full justify-start py-6 text-left text-base border-2 border-border hover:bg-purple-50 hover:border-purple-600 transition-all"
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-3xl font-bold text-foreground mb-3">Congratulations!</h3>
              <p className="text-lg text-muted-foreground mb-4">Your Compatibility Type:</p>
              ...
              <div className="bg-muted rounded-lg p-4 mb-6">
                <p className="text-sm text-muted-foreground mb-2">Your Compatibility Scores:</p>
