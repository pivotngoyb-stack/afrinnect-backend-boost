        ...
        <div className="bg-white rounded-xl p-8 shadow-sm space-y-6">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded">
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1 text-foreground text-sm">
              ...
              <ul className="list-disc pl-6 mt-1 space-y-1 text-foreground text-sm">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-none space-y-1 text-foreground mt-2">
