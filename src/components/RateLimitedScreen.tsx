...
export default function RateLimitedScreen({ retryAfter = 3600, onRetry }: RateLimitedScreenProps) {
        ...
        <Card className="border-orange-300 shadow-2xl">
          ...
          <CardContent className="p-8 space-y-6">
            ...
            <div className="text-center py-6">
              <div className="text-6xl font-bold text-orange-600 mb-2">{formatTime(timeLeft)}</div>
            ...
            <div className="space-y-3 bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2"><span className="text-blue-600 mt-0.5">•</span><span>Wait for the timer to reach zero</span></li>
                <li className="flex items-start gap-2"><span className="text-blue-600 mt-0.5">•</span><span>Use the "Forgot Password" option</span></li>
                <li className="flex items-start gap-2"><span className="text-blue-600 mt-0.5">•</span><span>Contact support if you believe this is an error</span></li>
              </ul>
            </div>

            <div className="flex flex-col gap-3 pt-4">
              <Button onClick={onRetry} disabled={timeLeft > 0} className="w-full gap-2">
                <RefreshCw size={18} />
