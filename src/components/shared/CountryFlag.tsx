...
const COUNTRY_FLAGS = {
  ...
  'Uganda': '🇺🇬', 'Algeria': '🇩🇿', 'Sudan': '🇸🇩', 'DR Congo': '🇨🇩',
  'Congo': '🇨🇬', 'Mozambique': '🇲🇿', 'Madagascar': '🇲🇬', 'Cameroon': '🇨🇲',
  'Ivory Coast': '🇨🇮', 'Angola': '🇦🇴', 'Niger': '🇳🇪', 'Mali': '🇲🇱',
  'Burkina Faso': '🇧🇫', 'Malawi': '🇲🇼', 'Zambia': '🇿🇲', 'Zimbabwe': '🇿🇼',
  'Senegal': '🇸🇳', 'Chad': '🇹🇩', 'Somalia': '🇸🇴', 'Guinea': '🇬🇳',
  'Rwanda': '🇷🇼', 'Benin': '🇧🇯', 'Burundi': '🇧🇮', 'Tunisia': '🇹🇳',
  'Togo': '🇹🇬', 'Sierra Leone': '🇸🇱', 'Libya': '🇱🇾', 'Liberia': '🇱🇷',
  ...
  'Central African Republic': '🇨🇫', 'South Sudan': '🇸🇸', 'Seychelles': '🇸🇨',
  'São Tomé and Príncipe': '🇸🇹',
  'USA': '🇺🇸', 'United States': '🇺🇸', 'United Kingdom': '🇬🇧', 'France': '🇫🇷',
  'Canada': '🇨🇦', 'Germany': '🇩🇪', 'Brazil': '🇧🇷', 'Jamaica': '🇯🇲',
  'Haiti': '🇭🇹', 'Trinidad and Tobago': '🇹🇹', 'Netherlands': '🇳🇱',
