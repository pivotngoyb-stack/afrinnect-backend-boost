...
export default function SuperLikeCounter({ userProfile, onBuyMore }) {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showBuyModal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/60 backdrop-blur-sm p-4" onClick={() => setShowBuyModal(false)}>
