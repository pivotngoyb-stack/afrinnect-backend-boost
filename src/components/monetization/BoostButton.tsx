      ...
      {showModal && (
        ...
        >
          <motion.div
            ...
            className="rounded-xl max-w-xs w-full shadow-2xl relative max-h-[72vh] overflow-y-auto px-4 py-5 mx-auto bg-secondary text-secondary-foreground text-center"
          >
